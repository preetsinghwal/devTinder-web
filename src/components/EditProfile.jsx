    ...
    return (
        <>
            <div className='flex justify-center'>
                <div className='flex justify-center mx-10 my-30 align-center items-center'>
                        ...
                        <div className="card-body">
                            ...
                            <div>
                                ...
                                <fieldset className="fieldset">
                                    ...
                                    <input type="text" className="input" value={photoUrl} onChange={(e) => setPhotoUrl(e.target.value)} required />
                                </fieldset>
                                ...
                                <fieldset className="fieldset">
                                    ...
                                    <textarea className="textarea" value={about} onChange={(e) => setAbout(e.target.value)} required />
                                </fieldset>
                            ...
                            <div className="card-actions justify-center mt-5">
                                <button className="btn btn-primary w-30" onClick={saveProfile}>Save</button>
                            </div>
                        </div>
                    </div>
                </div>
